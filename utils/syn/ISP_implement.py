...
import math
import skimage
from modules.demosaicing_CFA_Bayer_Malvar2004 import demosaicing_CFA_Bayer_Malvar2004
from modules.tone_mapping_cython import CRF_Map_Cython, ICRF_Map_Cython

class ISP:
    def __init__(self, curve_path='/media/data/ywh/CBDNet/utils/syn/'):
